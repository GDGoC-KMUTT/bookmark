...
type ModuleStepServiceTestSuite struct {
	...
	mockUserRepo     *mockRepositories.UserRepository
...
func (suite *ModuleStepServiceTestSuite) SetupTest() {
	...
	suite.mockUserRepo = mockRepositories.NewUserRepository(suite.T())
	suite.service = services.NewModuleStepService(suite.mockStepRepo, suite.mockUserEvalRepo, suite.mockUserRepo)
}
