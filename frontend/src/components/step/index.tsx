import { ArrowBigUp, BadgeCheck, Blocks, Check, CircleSlash, Gem, Loader, Loader2, MessageSquare, ShieldQuestion, TriangleAlert } from "lucide-react"
                                                        ...
                                                        {stepInfo.userPassed && (
                                                            <>
                                                                ...
                                                                <div className="flex relative py-3">
                                                                    ...
                                                                    {stepInfo.userPassed.length === 0 && (
                                                                        <Label>No one has passed this step yet.</Label>
                                                                    )}
                                                                </div>
                                                            </>
                                                        )}
