...
const Module = ({ moduleId }: { moduleId: number }) => {
	...
	if (!moduleData) {
	  ...
	  return (
		<div className="sm:w-[70%] xl:w-[800px] bg-white border-2 border-gray-300 shadow-sm rounded-lg p-10 flex flex-col sm:flex-row sm:space-x-6">
		  {/* Module Info */}
		  ...
		  {moduleData.image_url && (
			<div className="mt-4 sm:mt-0">
			  <img src={moduleData.image_url} alt="module image" className="w-[300px] h-[170px] rounded-sm object-cover" />
			</div>
		  )}
		</div>
	  );
